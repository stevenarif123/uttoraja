                ...
                <div class="col-xl-12">
                    <div class="contact-area__content">
                        <div class="sec-title-four">
                            <div class="sub-title">
                                <h4>Mengenal SALUT Tana Toraja</h4>
                            </div>
                            <h2>
                                Sentra Layanan Universitas Terbuka Tana Toraja
                            </h2>
                        </div>
                        <div class="text">
                            <p>
                                Sentra Layanan Universitas Terbuka (SALUT) Tana Toraja adalah unit layanan yang dibentuk oleh Universitas Terbuka untuk memberikan layanan dan dukungan kepada mahasiswa UT di wilayah Tana Toraja dan sekitarnya.
                            </p>
                            <p>
                                SALUT Tana Toraja hadir sebagai mitra UT untuk memfasilitasi mahasiswa dalam berbagai aspek perkuliahan, mulai dari pendaftaran, bimbingan belajar, akses internet, hingga informasi terkait ujian dan kelulusan.
                            </p>
                            <p>
                                <div style="text-align: center;">
                                    [Tempat untuk menyisipkan gambar SALUT Tana Toraja]
                                </div>
                            </p>
                            <p>
                            ...
                            <p>
                                Dengan adanya SALUT Tana Toraja, diharapkan mahasiswa UT dapat belajar dengan lebih nyaman dan efektif, serta meraih kesuksesan dalam studi mereka.
                            </p>
                        </div>
                    </div>
                </div>
