    ...
    <div class="page-wrapper">
      ...
      <section class="page-header">
        <div class="shape1 rotate-me">
          <img src="..//img/shape/page-header-shape1.png" alt="" />
        </div>
      ...
      <section id="contact" class="contact-area contact-bg pt-120 pb-100 p-relative fix mb-80">
        <div class="container">
          <div class="section-intro text-center mb-5">
            <h3 class="fw-bold">Bantuan Legalisir Ijazah</h3>
            <p class="lead">Hubungi admin kami untuk bantuan legalisir ijazah</p>
          </div>
            ...
            <div class="col-lg-6">
              <div class="contact-card h-100 p-4 rounded-3 shadow-sm hover-shadow">
                <div class="card-content text-center">
                  ...
                  <h4 class="card-title mb-3">Legalisir Ijazah</h4>
                  <div class="card-info mb-4">
                    <p class="mb-1">Layanan Legalisir Ijazah UT</p>
