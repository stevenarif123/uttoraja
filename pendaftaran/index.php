...
try {
  // 🔍 Check primary connection for jurusan data
  if (!$conn) {
  ...
  // 🏘️ Query kelurahan data from data_daerah database
  if (!$conn_daerah) {
...
<script>
  // Immediate preloader handling 🚀
  document.addEventListener('DOMContentLoaded', function() {
    const preloader = document.getElementById('preloader');
    if (preloader) {
      // Force remove after 2 seconds no matter what
      setTimeout(() => {
        preloader.classList.add('fade-out');
        setTimeout(() => preloader.remove(), 300);
      }, 2000);

      // Try to remove earlier if page is ready
                        ...
                        <div class="searchable-dropdown">
                          ...
                          <div class="dropdown-list">
                            <?php if (!empty($jurusanOptions)): ?>
                              ...
                              <?php endforeach; ?>
                            <?php else: ?>
                              <div class="dropdown-item">No programs available</div>
                            <?php endif; ?>
                          </div>
                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="contact-field">
                      <div class="input-wrapper date-picker-wrapper">
                        ...
                        <span class="input-description">Pilih tanggal lahir anda sesuai dengan yang tertera di KTP</span>
                      </div>
                    </div>
                  </div>
