...
$error_message = '';
$subtotal = 0;
$delivery_cost = 10000; // Default delivery cost
$total = 0;
$student_name = ''; // Variable to store student name

// Fetch student name if logged in with NIM
if (isset($_SESSION['nim'])) {
    $nim = $_SESSION['nim'];
    $stmt = $conn->prepare("SELECT name FROM Users WHERE nim = ?");
    if ($stmt) {
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="px-3 py-2 bg-green-50 text-green-800 rounded-md">
                                <div class="flex items-center">
                                    ...
                                    <p class="text-sm font-medium">Ordering as Student: <?php echo htmlspecialchars($student_name); ?></p>
                                </div>
                            </div>
                            <?php endif; ?>
